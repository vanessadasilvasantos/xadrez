...
export default function Rules() {
  return (
    <div className="flex flex-col items-center mb-[220px] mx-[140px]">
        ...
        <Title data-aos="slide-in-left" data-aos-duration="800" text="Regras" className="ml-auto" />
        <div className="w-[100%]">
          <p data-aos="fade-in" data-aos-delay="150" data-aos-duration="800" className="text-[var(--m6)] font-inter font-medium text-[24px] mt-[90px] w-[660px]">
