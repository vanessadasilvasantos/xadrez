...
export default function Board() {
  return (
    <div className="bg-[var(--c7)] rounded-[50px] relative pb-[280px] pt-[100px]">
      <Title data-aos="slide-in-left" data-aos-duration="800" text="Tabuleiro" className="mx-[140px] text-[var(--c6)]" />
      <p className="text-[var(--c1)] text-right ml-auto font-inter font-medium text-[24px] mr-[140px] mt-[110px]" data-aos="fade-in" data-aos-delay="150" data-aos-duration="800">
